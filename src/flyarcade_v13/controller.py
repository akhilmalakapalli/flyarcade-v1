"""Feature sources for the v1.3 learners.
...
from flyarcade.v12.environments import encoder
...
class FlyFeatures:
    ...
    def raw_rates(self, observations, columns=None, *, noise=0, edge_mask=None, neuron_mask=None):
        ...
        encoded = np.stack([encoder(o) for o in observations])[:, self.input_channels]
